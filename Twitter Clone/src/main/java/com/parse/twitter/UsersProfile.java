...
public class UsersProfile extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String username = intent.getStringExtra("userProfile");
		setTitle("@" + username +"\'s Tweets");
		...
		query.findInBackground(new FindCallback<ParseUser>() {
			...
			public void done(List<ParseUser> objects, ParseException e) {
				if (e == null) {
					...
					adapter = new SimpleAdapter(UsersProfile.this, fillMaps, R.layout.list_item, tweetInfo, tweetListInfo);
